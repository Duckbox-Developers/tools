...
#if !BOXMODEL_DM8000 && !BOXMODEL_E4HDULTRA && !BOXMODEL_VUULTIMO && !BOXMODEL_DM820 && !BOXMODEL_DM7080 && !BOXMODEL_DM900
...
void usage(char *prg, char *cmd)
{
	...
	fprintf(stderr, "Oled control tool, version 1.11 (VU 4K ARM, E4HD 4K Ultra, VU DUO2, VU ULTIMO)\n");
