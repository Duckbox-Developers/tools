...
#if defined(HAVE_SPARK_HARDWARE) || defined(HAVE_DUCKBOX_HARDWARE) || defined(HAVE_ARM_HARDWARE) || BOXMODEL_DM7020HD || BOXMODEL_DM800 || BOXMODEL_DM8000 || BOXMODEL_DM800SE || BOXMODEL_DM800SEV2 || BOXMODEL_DM7080 || BOXMODEL_DM820 || BOXMODEL_DM900 || BOXMODEL_DM920 || BOXMODEL_VUPLUS_ALL
	if (rc < 0)
...
void RenderMenuLine(int highlight, int refresh)
{
	...
	for (i = 0; i < COLORBUTTONS; i++)
	{
		...
		RenderBox( (viewx/COLORBUTTONS) *i ,viewy-MENUSIZE/2, (viewx/COLORBUTTONS) *(i+1) , viewy , FILL,  (i == 0 ? RED    :
		                                                            					                   (i == 1 ? GREEN  :
		                                                            					                   (i == 2 ? YELLOW : BLUE1))));
#if !BOXMODEL_DCUBE && !BOXMODEL_DM800 // 3rd value overflow?!
