...
#if defined(HAVE_SPARK_HARDWARE) || defined(HAVE_DUCKBOX_HARDWARE) || defined(HAVE_ARM_HARDWARE) || BOXMODEL_DM820 || BOXMODEL_DM900 || BOXMODEL_DM8000 || BOXMODEL_VUPLUS_ALL
	if (rc < 0)
