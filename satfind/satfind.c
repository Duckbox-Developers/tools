...
int main(int argc, char **argv)
{
	...
	int tune = 0;
	int nocolor = 0;
#if BOXMODEL_VUSOLO4K || BOXMODEL_VUDUO4K || BOXMODEL_VUDUO4KSE || BOXMODEL_VUULTIMO4K || BOXMODEL_VUUNO4KSE || BOXMODEL_DM8000 || BOXMODEL_DM820 || BOXMODEL_DM7080 || BOXMODEL_DM900 || BOXMODEL_DM920
	int useoled = 0;
#else
	int usevfd = 0;
#endif
...
#if BOXMODEL_VUSOLO4K || BOXMODEL_VUDUO4K || BOXMODEL_VUDUO4KSE || BOXMODEL_VUULTIMO4K || BOXMODEL_VUUNO4KSE || BOXMODEL_DM8000 || BOXMODEL_DM820 || BOXMODEL_DM7080 || BOXMODEL_DM900 || BOXMODEL_DM920
			oled=" [--useoled]";
			oled_help="--useoled		show BER/SNR/SIG at oled device (DM8000/DM7080 only with Grautec LCD)\n";
#else
			oled=" [--usevfd]";
